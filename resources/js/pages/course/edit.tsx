...
function CoursePreview({ course, withModule }: { course: Course, withModule: boolean }) {
    return (
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="edit" className="space-y-6 pt-4">
                    <div className="grid gap-6">
                        <CoursePreview course={course} withModule={false} />
                        <div className="space-y-4">
                ...
                <TabsContent value="preview">
                    <CoursePreview course={course} withModule={true} />
                </TabsContent>
            </Tabs>
        </div>
    )
